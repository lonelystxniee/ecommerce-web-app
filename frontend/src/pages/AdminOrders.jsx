...
const AdminOrders = () => {
  ...
  return (
    <div className="p-6">
      <h2 className="mb-4 text-xl font-bold">Danh sách đơn (Admin)</h2>
          ...
          {orders.map((o) => (
            <tr key={o._id} className="border-t">
              ...
              <td className="space-x-2">
                <button onClick={() => pushToGHN(o._id)} className="px-2 py-1 text-white bg-blue-600 rounded">
                  Gửi GHN
                </button>
                <button onClick={() => fetchGHNInfo(o._id)} className="px-2 py-1 text-white bg-gray-600 rounded">
                  Xem GHN
                </button>
              </td>
            </tr>
