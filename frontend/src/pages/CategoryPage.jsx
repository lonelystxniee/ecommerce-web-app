        ...
        <aside className="w-full md:w-65 shrink-0">
          <div className="sticky overflow-hidden bg-white border border-gray-200 rounded shadow-sm top-24">
            <div className="flex items-center gap-2 p-3 text-white bg-primary">
              <Filter size={18} />
              <h3 className="text-sm font-bold tracking-widest uppercase">Bộ lọc</h3>
            </div>
              ...
              >
                <div className="px-4 pb-6 space-y-3">
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg outline-none bg-gray-50 focus:border-primary"
                  />
                  <input
                    type="number"
                    placeholder="Đến"
          ...
          {loading ? (
            ...
            <div className="py-32 text-center text-gray-400 bg-white border border-gray-200 border-dashed rounded-lg">
              ...
              <button
                ...
                className="mt-4 text-xs font-bold underline text-primary underline-offset-4"
              >
                Xem tất cả sản phẩm
              </button>
            </div>
